...
1. Download `singlestore.metabase-driver.jar` from [GitHub Releases](https://github.com/singlestore-labs/metabase/releases) on this fork (tag `singlestore-driver-v*`).
